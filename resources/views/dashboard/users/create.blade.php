...
@endif --}}
    ...
    <div class="form-group">
        ...
        <input type="number" @class([ 'form-control','is-invalid' => $errors->has('phone')]) name="phone" value={{ old('phone') }} required >
         @if($errors->has('phone'))
        <div class="text-danger">
            {{ $errors->first('phone') }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="text" @class([ 'form-control','is-invalid' => $errors->has('city')]) name="city" value={{ old('city') }} required >
         @if($errors->has('city'))
        <div class="text-danger">
            {{ $errors->first('city') }}
        </div>
