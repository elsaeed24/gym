...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" @class([ 'form-control','is-invalid' => $errors->has('name')]) name="name" required >
         @if($errors->has('name'))
    ...
    <div class="form-group">
        ...
        <input type="email" @class([ 'form-control','is-invalid' => $errors->has('email')]) name="email" required >
         @if($errors->has('email'))
        <div class="text-danger">
            {{ $errors->first('email') }}
        </div>
    ...
    <div class="form-group">
        ...
        <input type="number" @class([ 'form-control','is-invalid' => $errors->has('national_id')]) name="national_id" required >
